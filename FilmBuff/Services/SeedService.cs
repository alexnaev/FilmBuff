...
namespace FilmBuff.Services
{
    public class SeedService
    {
        ...
        private async Task SeedRolesAsync()
        {
            ...
            var adminRole = _appSettings.FilmBuffSettings.DefaultCredentials.Role;
        ...
        private async Task SeedUsersAsync()
        {
            ...
            var credentials = _appSettings.FilmBuffSettings.DefaultCredentials;
        ...
        private async Task SeedCollections()
        {
            ...
            {
                Name = _appSettings.FilmBuffSettings.DefaultCollection.Name,
                Description = _appSettings.FilmBuffSettings.DefaultCollection.Description
            });
