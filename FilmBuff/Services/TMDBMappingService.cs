    ...
    public class TMDBMappingService : IDataMappingService
    {
        ...
        private string BuildCastImage(string profilePath)
        {
            if (string.IsNullOrEmpty(profilePath))
                return _appSettings.FilmBuffSettings.DefaultCastImage;
            
            return $"{_appSettings.TMDBSettings.BaseImagePath}/{_appSettings.FilmBuffSettings.DefaultPosterSize}/{profilePath}";
        }
        ...
        {
            var posterPath = $"{_appSettings.TMDBSettings.BaseImagePath}/{_appSettings.FilmBuffSettings.DefaultPosterSize}/{path}";
        ...
        {
            var backdropPath = $"{_appSettings.TMDBSettings.BaseImagePath}/{_appSettings.FilmBuffSettings.DefaultBackdropSize}/{path}";
